...
return [
    ...
    */
    ...
    'brand' =>  [
        //'logo' => realpath(__DIR__.'/../public/vendor/orchid/favicon.svg'),
        'color' => '#86EFAC',
    ],
    ...
    */
    ...
    'receipt_data' => [
        'vendor' => 'WhatsHook',
        'product' => 'WhatsHook Plan',
        'street' => '2810 North Church Street',
        'location' => 'Wilmington, DE',
        'phone' => '55-51-99889-2698',
    ],
    ...
    'billables' => [
        ...
        'user' => [
            ...
            'plans' => [
                [
                    'name' => 'Standard',
                    'short_description' => 'WhatsHook Plan.',
                    'monthly_id' => 'price_1NHTehDafby0rIHzn5GK7t1o',
                    'yearly_id' => 'price_1NHTiIDafby0rIHzLXHh321U',
                    'features' => [
                        'Unlimited WebHooks URLs',
